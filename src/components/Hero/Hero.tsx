  ...
  return (
    <div className="relative">
      ...
      <div className="relative">
        <header>
          <nav>
            <div className="flex items-center max-w-screen-xl mx-auto px-6 py-6 justify-between ">
              {/* <Brand /> */}
              <p className=" text-2xl font-bold text-primary">ProfitPulse</p>
              <a
                href="https://github.com/jonniermartinez/ProfitPulse"
                target="_blank"
        ...
        <section>
          ...
          <div className="py-8 flex flex-col gap-6 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12 h-screen max-h-[600px]">
            ...
            <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">
              Do you want to see how your money grows over time? Find out how
              much you could earn with our Compound Interest Calculator.
            </p>
